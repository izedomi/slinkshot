...
//screen height factor ratio
double screenHeightFactorRatio(BuildContext context) {
  return height(context) / 812;
}

//screen height factor ratio
double screenWidthFactorRatio(BuildContext context) {
  if (width(context) < 360) {
    return width(context) / 400;
  }
  if (width(context) < 576) {
    return width(context) / 375;
  }
  if (width(context) > 576) {
    return width(context) / 576;
  }
